#ifndef VELO_TESTS_TYPELIST_HPP
#define VELO_TESTS_TYPELIST_HPP
...
//TypeAt
	...
	struct TypeAt<TypeList<Head, Tail...>, 0> { typedef Head type; };

	template<class Head, class ...Tail, unsigned int index>
	struct TypeAt<TypeList<Head, Tail...>, index> { typedef typename TypeAt<TypeList<Tail...>, index - 1>::type type; };
